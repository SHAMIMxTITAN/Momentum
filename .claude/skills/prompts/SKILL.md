---
name: prompts
description: Show the copy-paste prompts for saving to and getting from GitHub. Use when the user says /prompts, "give me the prompt", "show me the prompts", or wants prompt text to paste somewhere else (another machine, the Claude web app, a fresh session).
---
...
> If you're already in Claude Code, just type `/save` or `/get` instead — no pasting needed.
